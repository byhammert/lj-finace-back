...
public class DefaultCreateRevenuePostUseCase extends CreateRevenuePostUseCase {
    ...
    public DefaultCreateRevenuePostUseCase(final PostGateway postGateway,
    ...
    @Override
    public Either<Notification, CreateRevenuePostOutput> execute(CreateRevenuePostCommand aCommand) {
    ...
    private Either<Notification, CreateRevenuePostOutput> create(final Post aPost) {
        return Try(() -> this.postGateway.create(aPost))
                .toEither()
                .bimap(Notification::create, CreateRevenuePostOutput::from);
    }
}
