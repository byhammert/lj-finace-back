package com.lj.infrastructure.configuration.json;
...
public enum Json {
    ...
    private final ObjectMapper mapper = new Jackson2ObjectMapperBuilder()
            ...
            .modules(new JavaTimeModule(), new Jdk8Module(), afterBurnerModules())
            .propertyNamingStrategy(PropertyNamingStrategies.SNAKE_CASE)
            .build();

    private AfterburnerModule afterBurnerModules() {
